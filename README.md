# SC-300 — Identity & Access Management Labs

## Overview

This repository documents my hands-on labs for the Microsoft SC-300: Identity and Access Administrator certification.
...
## Lab Environment
	...
	•	Microsoft Developer Program tenant
	•	Role: Global Administrator (lab environment only)
...
Identity and Access Management is a core enterprise security function.
These labs reflect real-world IAM responsibilities used by:
...
Stephan Watkis-Davis
Security & Identity Labs
Microsoft Entra ID | IAM | Cloud Security
